...
public final class CameraManager {
	...
	private CameraManager(Context context) {
		...
		MAX_FRAME_WIDTH = context.getResources().getInteger(R.integer.qr_max_camera_frame_width);
		MAX_FRAME_HEIGHT = context.getResources().getInteger(R.integer.qr_max_camera_frame_height);
		Log.d("tag_honda", this + " MAX_FRAME_WIDTH = " + MAX_FRAME_WIDTH + " MAX_FRAME_HEIGHT = " + MAX_FRAME_HEIGHT);
	}
